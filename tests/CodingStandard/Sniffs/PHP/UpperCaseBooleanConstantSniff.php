 ...
 */
class CodingStandard_Sniffs_PHP_UpperCaseBooleanConstantSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (strtoupper($keyword) !== $keyword) {
            $error = 'TRUE, FALSE must be lowercase; expected "%s" but found "%s"';
            $data  = array(
                      strtolower($keyword),
                      $keyword,
                     );
